...
const mockKBArticles: KBArticle[] = [
  {
    ...
    content: "This comprehensive guide covers common SMTP configuration problems and their solutions. SMTP (Simple Mail Transfer Protocol) is crucial for email delivery...",
    category: "Email",
  ...
  },
  {
    ...
    content: "Safe procedures for restarting email services without losing queued messages. This guide ensures minimal downtime...",
    category: "Operations",
  ...
  },
  {
    ...
    content: "Comprehensive guide to optimizing database performance including indexing strategies, query optimization...",
    category: "Performance",
    tags: ["database", "performance", "optimization", "indexing"],
    relevance_score: 0.89,
    content_preview: "Learn how to optimize database queries and improve overall system performance."
  },
  {
    id: 4,
    title: "Security Best Practices for Web Applications",
    content: "Essential security practices for web applications including authentication, authorization, data validation...",
    category: "Security",
    tags: ["security", "web", "authentication", "best-practices"],
    relevance_score: 0.92,
    content_preview: "Comprehensive security guidelines to protect your web applications from common vulnerabilities."
  },
  {
    id: 5,
    title: "Mobile App Crash Debugging Guide",
    content: "Step-by-step guide to debug mobile application crashes, including log analysis and common crash patterns...",
    category: "Mobile",
    tags: ["mobile", "debugging", "crashes", "ios", "android"],
    relevance_score: 0.85,
    content_preview: "Learn how to effectively debug and resolve mobile application crashes."
  }
];

const categories = ["All", "Email", "Operations", "Performance", "Security", "Mobile", "Integration"];
...
export default function KnowledgeBase() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      showSuccess(`File "${uploadFile.name}" uploaded and processed successfully`);
      setUploadFile(null);
      setUploadCategory("");
  ...
  const handleUrlCrawl = async () => {
    ...
    try {
      ...
      showSuccess(`URL crawled successfully. Found ${Math.floor(Math.random() * 10) + 1} new articles.`);
      setCrawlUrl("");
      setCrawlCategory("");
      setMaxDepth(1);
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={crawlCategory} onValueChange={setCrawlCategory}>
                    <SelectTrigger>
                ...
                <Button onClick={handleUrlCrawl} disabled={loading} className="w-full">
          ...
          <Dialog open={isUploadDialogOpen} onOpenChange={setIsUploadDialogOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleFileUpload} disabled={loading || !uploadFile} className="w-full">
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleCreateArticle} disabled={loading} className="w-full">
          ...
          <Card key={article.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-4 line-clamp-3">
                {article.content_preview || article.content.substring(0, 150) + "..."}
              </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {Math.round(articles.reduce((acc, article) => acc + (article.relevance_score || 0), 0) / articles.length * 100)}%
                </p>
              </div>
