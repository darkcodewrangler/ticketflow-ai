...
import { DashboardMetrics, ActivityItem, ConnectionStatus, WebSocketMessage } from '@/types';
      ...
      case 'agent_update':
        if (message.ticket_id && message.step && message.message) {
          const update: ActivityItem = {
            ...
            metadata: { ticket_id: message.ticket_id, step: message.step, data: message.data },
          };
